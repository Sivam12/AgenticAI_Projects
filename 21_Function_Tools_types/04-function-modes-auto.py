...
def auto_mode_fun():
    ...
    prompt = """Tell me something I can use to help understand Indian culture, 
    It is not necessary to call provided function tools."""
    
    prompt = "When is Diwali typically celebrated?  Also, tell me about the Chennai Super Kings."
    print(f"Prompt :{prompt}")
    
    umode = protos.FunctionCallingConfig.Mode.AUTO
